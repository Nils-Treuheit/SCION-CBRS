...
func (p snetPathWrapper) UnderlayNextHop() *net.UDPAddr { new_panic("not implemented") }

func (p snetPathWrapper) Dataplane() snet.DataplanePath { new_panic("not implemented") }
func (p snetPathWrapper) Source() addr.IA               { new_panic("not implemented") }
func (p snetPathWrapper) Destination() addr.IA          { new_panic("not implemented") }
func (p snetPathWrapper) Copy() snet.Path               { new_panic("not implemented") }
