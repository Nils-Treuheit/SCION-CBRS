...
const (
	...
	// pathRefreshLeadTime specifies when a refresh is triggered for a
	// path, relative to its expiry.
	pathRefreshLeadTime = 2 * time.Minute
	// pathPruneLeadTime specifies when, relative to its expiry, a path
