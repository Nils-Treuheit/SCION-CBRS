...
/*
Package new_pan provides a policy-based, path aware network library for building
...
new_pan differentiates between dialed and listening sockets. Dialed sockets (for
...
Notes
  ...
  - new_pan only performs path lookups for destinations requested by the application.
