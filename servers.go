...
func main() {
	var ivrs new_pan.ReplySelector = NewSmartReplySelector(2)
	var vsrs new_pan.ReplySelector = NewSmartReplySelector(1)
	var grs new_pan.ReplySelector = NewSmartReplySelector(0)
	...
	case "nors":
		...
		ivrs = new_pan.NewDefaultReplySelector()
		vsrs = new_pan.NewDefaultReplySelector()
		grs = new_pan.NewDefaultReplySelector()
	case "rrrs":
...
func startServs(ivrs new_pan.ReplySelector, vsrs new_pan.ReplySelector, grs new_pan.ReplySelector) {
...
*/
func file_server(directory *string, port *string, rs new_pan.ReplySelector) {
...
*/
func content_server(webDir *string, webPort *string, rs new_pan.ReplySelector) {
...
*/
func web_server(webDir *string, tslPort *string, webPort *string, rs new_pan.ReplySelector) {
	webpage := "index.html"
